...
export default function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Different plants have different light requirements. Most indoor plants thrive in bright, indirect light - near a window but not in direct sun, which can scorch leaves. Low-light plants like pothos or snake plants can do well in bathrooms or corners away from windows. Observe how sunlight moves through your space throughout the day to find the perfect spot for each plant.",
    },
    {
      question: "How often should I fertilize my plants?",
      answer:
        "Feed your plants with a suitable fertilizer during the growing season (spring and summer), typically every 2-4 weeks. Plants are actively growing during this period and need extra nutrients. In fall and winter, reduce or stop fertilizing as most plants enter a dormant phase and require less nutrition.",
    },
    {
      question: "How can I increase humidity for tropical plants?",
      answer:
        "Tropical plants love humidity! You can mist the leaves regularly with water, place the pot on a pebble tray filled with water (ensuring the pot sits above water level), or use a humidifier nearby. Alternatively, group plants together or place humidity-loving plants in naturally humid areas like bathrooms or kitchens.",
    },
    {
      question: "When should I repot my plant?",
      answer:
        "Repot your plant when it has outgrown its current pot - signs include roots growing through drainage holes, water running straight through without absorbing, or the plant becoming top-heavy. Spring is the best time to repot. Choose a pot 1-2 inches larger in diameter, ensure it has drainage holes, and use quality potting mix appropriate for your plant type.",
    },
  ];
